...
function abdulrauf_adminreCaptcha_init() {
    yourls_register_plugin_page( 'adminreCaptcha', 'Greffon reCaptcha', 'adminreCaptcha_config_page' );
}
...
function adminreCaptcha_config_page() {
    ...
    echo '<h2>Paramètres du greffon reCaptcha</h2>';
    echo '<form method="post">';
    echo '<input type="hidden" name="nonce" value="' . $nonce . '" />';
    echo '<p><label for="abdulrauf_adminreCaptcha_public_key">Clé reCaptcha ( site ): </label>';
    echo '<input type="text" id="abdulrauf_adminreCaptcha_public_key" name="abdulrauf_adminreCaptcha_public_key" value="' . $pubkey . '"></p>';  
    echo '<p><label for="abdulrauf_adminreCaptcha_private_key">Clé reCaptcha (secret): </label>';
